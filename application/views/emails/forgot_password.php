...
<body>
	<!--*|IF:MC_PREVIEW_TEXT|*-->
	<!--[if !gte mso 9]><!----><span class="mcnPreviewText" style="display:none; font-size:0px; line-height:0px; max-height:0px; max-width:0px; opacity:0; overflow:hidden; visibility:hidden; mso-hide:all;"><?= $subject;?></span>
	<!--<![endif]-->
	<!--*|END:IF|*-->
	<center>
													...
													<tbody>
														<tr>
															...
															<td valign="top" class="mcnTextContent" style="padding-top:0; padding-right:18px; padding-bottom:9px; padding-left:18px;">
																...
																You requested for a password reset. If you did not authorise this request, ignore this email.<br>
																<br>
